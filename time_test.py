...
def vector_test(num_exp=100):
    from nn_row import MLP
    from optimizers import GD
    from losses_row import mse_loss
    from grad_engine_row import draw_dot, Vector
    import numpy as np
    import random
    random.seed(42)
    ...
    print("Average Vector way time: ", (stop-start)/num_exp)
